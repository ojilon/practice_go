# reflection — Tags & Mini-Marshal — Questions (run code, then EDIT answers here)
...
---
### Q1: Dump struct{Name string `mini:"n"`} → paste output showing tag.
...
### Q2: Code-only — no answer required.

Code-only — no answer required.


---
## Self-check before asking for verification
- [ ] All boxes above filled (or marked Code-only)?
- [ ] `go vet ./phase_04_systems/36_reflection/...` clean?
