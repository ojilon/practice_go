# hashmap — Hash Table From Scratch — Questions (run code, then EDIT answers here)
...
---
### Q1: Put 100 keys, Len=? LoadFactor=? Paste.
...
### Q2: After Delete 1 key, Get returns ok=false? Paste proof.
...
- [ ] `go vet ./phase_03_dsa/28_hashmap/...` clean?
