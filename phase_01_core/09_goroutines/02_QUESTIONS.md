# Goroutines — Questions (run code, then EDIT answers here)
...
---
### Q1: Final counter value with mutex? Paste number (expect 100000).
...
### Q2: Paste `go run -race .` result line for unfixed vs fixed (or describe).
...
- [ ] `go vet ./phase_01_core/09_goroutines/...` clean?
